  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with VirtueShop! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by VirtueShop.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to VirtueShop's acceptance. We may refuse to
        ...
        <p>
          ...
          VirtueShop. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock VirtueShop products. We
        ...
        <p>
          ...
          taxes, except for those based on VirtueShop's income. If
          VirtueShop is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without VirtueShop's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold VirtueShop harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between VirtueShop and
